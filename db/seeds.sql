...
INSERT INTO cource (name, description) values ('html5','entry level cource');
INSERT INTO cource (name, description) values ('C','fundamentals of programming');
INSERT INTO cource (name, description) values ('javascript','Async BS');

INSERT into users_to_cource (userid, courceid) values ('ankita', 2);
